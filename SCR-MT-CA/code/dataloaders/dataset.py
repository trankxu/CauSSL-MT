...
#N_CLASSES = 9
#CLASS_DICT = {'ADI':0, 'BACK':1, 'LYM':2, 'STR':3, 'DEB':4, 'MUC':5, 'TUM':6, 'MUS':7, 'NORM':8}
#CLASS_NAMES = ['ADI', 'BACK', 'LYM', 'STR', 'DEB', 'MUC', 'TUM', 'MUS', 'NORM']

#N_CLASSES = 10
#CLASS_NAMES = ['angiectasia', 'blood', 'Erosion', 'Foreign', 'Ileocecal', 'Lymph', 'Norm', 'Pylorus', 'Red', 'Ulcer']
